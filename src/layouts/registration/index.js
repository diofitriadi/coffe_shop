...
const Register = () => {
  const { loading, data, error, isRegister } = useSelector(
      ...
      <div>
        <div className="flex flex-row">
          ...
          <div className="p-5 w-full">
              ...
              <div className="flex justify-between lg:mx-20 w-full items-center">
                <div className="flex flex-col">
                  <div className="flex items-center justify-center">
                    ...
                    />
                    <p className="font-bold text-[#0B132A] mt-3">Coffee Shop</p>
                  </div>
                </div>
              ...
              <div className="flex flex-col justify-center md:mx-20 lg:mx-32 mt-12">
                ...
                <div className="flex ">
                  <div className="w-full px-3 mb-5">
                    <label for="" className="text-md font-semibold px-1">
                      Email :{" "}
                    </label>
                ...
                <div className="flex">
                  <div className="w-full px-3 mb-5 mt-10">
                    {disable ? (
                    <button className="hover:bg-amber-700 bg-yellow-500 border-amber-700 border-2 text-white hover:yellow-500 font-bold py-4 rounded-xl transition ease-out w-full opacity-50">
                      Sign-Up
                    </button>
                    ) : (
            ...
            <div className="md:absolute bg-white md:right-52 md:mt-14 hover:border-yellow-800 transition border-2 p-8 md:mx-0 mx-auto md:w-4/6 w-5/6 mt-10 rounded-2xl">
              <div className="flex">
                <div className="flex md:flex-row flex-col justify-between w-full items-center">
                  <div className="flex flex-col">
                    <h1 className="md:mb-4 text-2xl mb-4">
                      Get Your member
                      <br />
                      card now
                    </h1>
